...
class TableModel(object):
    ...
    def getRecordAtRow(self, rowIndex):
        ...
        name = self.getRecName(int(rowIndex))
    ...
    def setRecName(self, newname, rowIndex):
        ...
        if len(self.reclist)==0:
            return None
        currname = self.getRecName(int(rowIndex))
        self.reclist[int(rowIndex)] = newname
    ...
    def getRecordAttributeAtColumn(self, rowIndex=None, columnIndex=None,
         ...
         if columnName != None and recName != None:
             ...
             cell = self.getCellRecord(int(rowIndex), columnIndex)
    ...
    def deleteRow(self, rowIndex=None, key=None, update=True):
        ...
        if key == None or not key in self.reclist:
            key = self.getRecName(int(rowIndex))
        del self.data[key]
        if update==True:
    ...
    def getValueAt(self, rowIndex, columnIndex):
         ...
         value = self.getRecordAttributeAtColumn(int(rowIndex), columnIndex)
         return value
    ...
    def getRecColNames(self, rowIndex, ColIndex):
        ...
        recname = self.getRecName(int(rowIndex))
    ...
    def appendtoFormula(self, formula, rowIndex, colIndex):
        ...
        cellRec = getRecColNames(int(rowIndex), colIndex)
